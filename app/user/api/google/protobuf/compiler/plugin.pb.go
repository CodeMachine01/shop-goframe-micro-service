...
type Version struct {
	...
	Suffix        *string `protobuf:"bytes,4,opt,name=suffix" json:"suffix,omitempty" dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases." dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases." dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases."`
...
type CodeGeneratorRequest struct {
	...
	Parameter *string `protobuf:"bytes,2,opt,name=parameter" json:"parameter,omitempty" dc:"The generator parameter passed on the command-line." dc:"The generator parameter passed on the command-line." dc:"The generator parameter passed on the command-line."`
	...
	// fully qualified.
	ProtoFile []*descriptorpb.FileDescriptorProto `protobuf:"bytes,15,rep,name=proto_file,json=protoFile" json:"proto_file,omitempty" dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified." dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified." dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified."`
	// File descriptors with all options, including source-retention options.
	// These descriptors are only provided for the files listed in
	// files_to_generate.
	SourceFileDescriptors []*descriptorpb.FileDescriptorProto `protobuf:"bytes,17,rep,name=source_file_descriptors,json=sourceFileDescriptors" json:"source_file_descriptors,omitempty" dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate." dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate." dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate."`
	// The version number of protocol compiler.
	CompilerVersion *Version `protobuf:"bytes,3,opt,name=compiler_version,json=compilerVersion" json:"compiler_version,omitempty" dc:"The version number of protocol compiler." dc:"The version number of protocol compiler." dc:"The version number of protocol compiler."`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CodeGeneratorResponse_File struct {
	...
	InsertionPoint *string `protobuf:"bytes,2,opt,name=insertion_point,json=insertionPoint" json:"insertion_point,omitempty" dc:"If |insertion_point| is present, |name| must also be present." dc:"If |insertion_point| is present, |name| must also be present." dc:"If |insertion_point| is present, |name| must also be present."`
	// The file contents.
	Content *string `protobuf:"bytes,15,opt,name=content" json:"content,omitempty" dc:"The file contents." dc:"The file contents." dc:"The file contents."`
