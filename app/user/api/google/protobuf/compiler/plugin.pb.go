...
type Version struct {
	...
	Suffix        *string `protobuf:"bytes,4,opt,name=suffix" json:"suffix,omitempty" dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases." dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases." dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases." dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases." dc:"A suffix for alpha, beta or rc release, e.g., 'alpha-1', 'rc2'. It shouldbe empty for mainline stable releases."`
...
type CodeGeneratorRequest struct {
	...
	FileToGenerate []string `protobuf:"bytes,1,rep,name=file_to_generate,json=fileToGenerate" json:"file_to_generate,omitempty" dc:"The .proto files that were explicitly listed on the command-line.  Thecode generator should generate code only for these files.  Each file'sdescriptor will be included in proto_file, below." dc:"The .proto files that were explicitly listed on the command-line.  Thecode generator should generate code only for these files.  Each file'sdescriptor will be included in proto_file, below." dc:"The .proto files that were explicitly listed on the command-line.  Thecode generator should generate code only for these files.  Each file'sdescriptor will be included in proto_file, below." dc:"The .proto files that were explicitly listed on the command-line.  Thecode generator should generate code only for these files.  Each file'sdescriptor will be included in proto_file, below." dc:"The .proto files that were explicitly listed on the command-line.  Thecode generator should generate code only for these files.  Each file'sdescriptor will be included in proto_file, below."`
	// The generator parameter passed on the command-line.
	Parameter *string `protobuf:"bytes,2,opt,name=parameter" json:"parameter,omitempty" dc:"The generator parameter passed on the command-line." dc:"The generator parameter passed on the command-line." dc:"The generator parameter passed on the command-line." dc:"The generator parameter passed on the command-line." dc:"The generator parameter passed on the command-line."`
	...
	// fully qualified.
	ProtoFile []*descriptorpb.FileDescriptorProto `protobuf:"bytes,15,rep,name=proto_file,json=protoFile" json:"proto_file,omitempty" dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified." dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified." dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified." dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified." dc:"Type names of fields and extensions in the FileDescriptorProto are alwaysfully qualified."`
	// File descriptors with all options, including source-retention options.
	// These descriptors are only provided for the files listed in
	// files_to_generate.
	SourceFileDescriptors []*descriptorpb.FileDescriptorProto `protobuf:"bytes,17,rep,name=source_file_descriptors,json=sourceFileDescriptors" json:"source_file_descriptors,omitempty" dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate." dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate." dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate." dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate." dc:"File descriptors with all options, including source-retention options.These descriptors are only provided for the files listed infiles_to_generate."`
	// The version number of protocol compiler.
	CompilerVersion *Version `protobuf:"bytes,3,opt,name=compiler_version,json=compilerVersion" json:"compiler_version,omitempty" dc:"The version number of protocol compiler." dc:"The version number of protocol compiler." dc:"The version number of protocol compiler." dc:"The version number of protocol compiler." dc:"The version number of protocol compiler."`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CodeGeneratorResponse struct {
	...
	Error *string `protobuf:"bytes,1,opt,name=error" json:"error,omitempty" dc:"This should be used to indicate errors in .proto files which prevent thecode generator from generating correct code.  Errors which indicate aproblem in protoc itself -- such as the input CodeGeneratorRequest beingunparseable -- should be reported by writing a message to stderr andexiting with a non-zero status code." dc:"This should be used to indicate errors in .proto files which prevent thecode generator from generating correct code.  Errors which indicate aproblem in protoc itself -- such as the input CodeGeneratorRequest beingunparseable -- should be reported by writing a message to stderr andexiting with a non-zero status code." dc:"This should be used to indicate errors in .proto files which prevent thecode generator from generating correct code.  Errors which indicate aproblem in protoc itself -- such as the input CodeGeneratorRequest beingunparseable -- should be reported by writing a message to stderr andexiting with a non-zero status code." dc:"This should be used to indicate errors in .proto files which prevent thecode generator from generating correct code.  Errors which indicate aproblem in protoc itself -- such as the input CodeGeneratorRequest beingunparseable -- should be reported by writing a message to stderr andexiting with a non-zero status code." dc:"This should be used to indicate errors in .proto files which prevent thecode generator from generating correct code.  Errors which indicate aproblem in protoc itself -- such as the input CodeGeneratorRequest beingunparseable -- should be reported by writing a message to stderr andexiting with a non-zero status code."`
	// A bitmask of supported features that the code generator supports.
	// This is a bitwise "or" of values from the Feature enum.
	SupportedFeatures *uint64 `protobuf:"varint,2,opt,name=supported_features,json=supportedFeatures" json:"supported_features,omitempty" dc:"A bitmask of supported features that the code generator supports.This is a bitwise 'or' of values from the Feature enum." dc:"A bitmask of supported features that the code generator supports.This is a bitwise 'or' of values from the Feature enum." dc:"A bitmask of supported features that the code generator supports.This is a bitwise 'or' of values from the Feature enum." dc:"A bitmask of supported features that the code generator supports.This is a bitwise 'or' of values from the Feature enum." dc:"A bitmask of supported features that the code generator supports.This is a bitwise 'or' of values from the Feature enum."`
	// The minimum edition this plugin supports.  This will be treated as an
	// Edition enum, but we want to allow unknown values.  It should be specified
	// according the edition enum value, *not* the edition number.  Only takes
	// effect for plugins that have FEATURE_SUPPORTS_EDITIONS set.
	MinimumEdition *int32 `protobuf:"varint,3,opt,name=minimum_edition,json=minimumEdition" json:"minimum_edition,omitempty" dc:"The minimum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The minimum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The minimum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The minimum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The minimum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set."`
	// The maximum edition this plugin supports.  This will be treated as an
	// Edition enum, but we want to allow unknown values.  It should be specified
	// according the edition enum value, *not* the edition number.  Only takes
	// effect for plugins that have FEATURE_SUPPORTS_EDITIONS set.
	MaximumEdition *int32                        `protobuf:"varint,4,opt,name=maximum_edition,json=maximumEdition" json:"maximum_edition,omitempty" dc:"The maximum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The maximum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The maximum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The maximum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set." dc:"The maximum edition this plugin supports.  This will be treated as anEdition enum, but we want to allow unknown values.  It should be specifiedaccording the edition enum value, *not* the edition number.  Only takeseffect for plugins that have FEATURE_SUPPORTS_EDITIONS set."`
...
type CodeGeneratorResponse_File struct {
	...
	Name *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty" dc:"If the name is omitted, the content will be appended to the previousfile.  This allows the generator to break large files into small chunks,and allows the generated text to be streamed back to protoc so that largefiles need not reside completely in memory at one time.  Note that as ofthis writing protoc does not optimize for this -- it will read the entireCodeGeneratorResponse before writing files to disk." dc:"If the name is omitted, the content will be appended to the previousfile.  This allows the generator to break large files into small chunks,and allows the generated text to be streamed back to protoc so that largefiles need not reside completely in memory at one time.  Note that as ofthis writing protoc does not optimize for this -- it will read the entireCodeGeneratorResponse before writing files to disk." dc:"If the name is omitted, the content will be appended to the previousfile.  This allows the generator to break large files into small chunks,and allows the generated text to be streamed back to protoc so that largefiles need not reside completely in memory at one time.  Note that as ofthis writing protoc does not optimize for this -- it will read the entireCodeGeneratorResponse before writing files to disk." dc:"If the name is omitted, the content will be appended to the previousfile.  This allows the generator to break large files into small chunks,and allows the generated text to be streamed back to protoc so that largefiles need not reside completely in memory at one time.  Note that as ofthis writing protoc does not optimize for this -- it will read the entireCodeGeneratorResponse before writing files to disk." dc:"If the name is omitted, the content will be appended to the previousfile.  This allows the generator to break large files into small chunks,and allows the generated text to be streamed back to protoc so that largefiles need not reside completely in memory at one time.  Note that as ofthis writing protoc does not optimize for this -- it will read the entireCodeGeneratorResponse before writing files to disk."`
	...
	InsertionPoint *string `protobuf:"bytes,2,opt,name=insertion_point,json=insertionPoint" json:"insertion_point,omitempty" dc:"If |insertion_point| is present, |name| must also be present." dc:"If |insertion_point| is present, |name| must also be present." dc:"If |insertion_point| is present, |name| must also be present." dc:"If |insertion_point| is present, |name| must also be present." dc:"If |insertion_point| is present, |name| must also be present."`
	// The file contents.
	Content *string `protobuf:"bytes,15,opt,name=content" json:"content,omitempty" dc:"The file contents." dc:"The file contents." dc:"The file contents." dc:"The file contents." dc:"The file contents."`
	// Information describing the file content being inserted. If an insertion
	// point is used, this information will be appropriately offset and inserted
	// into the code generation metadata for the generated files.
	GeneratedCodeInfo *descriptorpb.GeneratedCodeInfo `protobuf:"bytes,16,opt,name=generated_code_info,json=generatedCodeInfo" json:"generated_code_info,omitempty" dc:"Information describing the file content being inserted. If an insertionpoint is used, this information will be appropriately offset and insertedinto the code generation metadata for the generated files." dc:"Information describing the file content being inserted. If an insertionpoint is used, this information will be appropriately offset and insertedinto the code generation metadata for the generated files." dc:"Information describing the file content being inserted. If an insertionpoint is used, this information will be appropriately offset and insertedinto the code generation metadata for the generated files." dc:"Information describing the file content being inserted. If an insertionpoint is used, this information will be appropriately offset and insertedinto the code generation metadata for the generated files." dc:"Information describing the file content being inserted. If an insertionpoint is used, this information will be appropriately offset and insertedinto the code generation metadata for the generated files."`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
